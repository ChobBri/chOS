...
kernel: entry.o terminal.o kernel.o irq_stub.o linker.ld
	~/opt/cross/bin/i686-elf-gcc -T linker.ld -o kernel -ffreestanding -O2 -nostdlib entry.o terminal.o irq_stub.o kernel.o -lgcc
...
clean:
	rm entry.o terminal.o kernel.o irq_stub.o kernel