...
void init_mode13() {
    vga::write_misc_output_reg(0x63);
    
    vga::write_seq_reg(0x00, 0x03);
    vga::write_seq_reg(0x01, 0x01);
    vga::write_seq_reg(0x02, 0x0F);
    vga::write_seq_reg(0x03, 0x00);
    vga::write_seq_reg(0x04, 0x0E);

    vga::write_atrb_reg(0x00, 0x00);
    vga::write_atrb_reg(0x01, 0x01);
    vga::write_atrb_reg(0x02, 0x02);
    vga::write_atrb_reg(0x03, 0x03);
    vga::write_atrb_reg(0x04, 0x04);
    vga::write_atrb_reg(0x05, 0x05);
    vga::write_atrb_reg(0x06, 0x06);
    vga::write_atrb_reg(0x07, 0x07);
    vga::write_atrb_reg(0x08, 0x08);
    vga::write_atrb_reg(0x09, 0x09);
    vga::write_atrb_reg(0x0A, 0x0A);
    vga::write_atrb_reg(0x0B, 0x0B);
    vga::write_atrb_reg(0x0C, 0x0C);
    vga::write_atrb_reg(0x0D, 0x0D);
    vga::write_atrb_reg(0x0E, 0x0E);
    vga::write_atrb_reg(0x0F, 0x0F);

    vga::write_atrb_reg(0x10, 0x41);
    vga::write_atrb_reg(0x11, 0x00);
    vga::write_atrb_reg(0x12, 0x0F);
    vga::write_atrb_reg(0x13, 0x00);
    vga::write_atrb_reg(0x14, 0x00);
    


    vga::write_gfx_reg(0x00, 0x00);
    vga::write_gfx_reg(0x01, 0x00);
    vga::write_gfx_reg(0x02, 0x00);
    vga::write_gfx_reg(0x03, 0x00);
    vga::write_gfx_reg(0x04, 0x00);
    vga::write_gfx_reg(0x05, 0x40);
    vga::write_gfx_reg(0x06, 0x05);
    vga::write_gfx_reg(0x07, 0x0F);
    vga::write_gfx_reg(0x08, 0xFF);

    vga::write_crt_ctrl_reg(0x03, vga::read_crt_ctrl_reg(0x03) | 0x80);
    vga::write_crt_ctrl_reg(0x11, vga::read_crt_ctrl_reg(0x11) & ~0x80);

    vga::write_crt_ctrl_reg(0x00, 0x5F);
    vga::write_crt_ctrl_reg(0x01, 0x4F);
    vga::write_crt_ctrl_reg(0x02, 0x50);
    vga::write_crt_ctrl_reg(0x03, 0x82);
    vga::write_crt_ctrl_reg(0x04, 0x54);
    vga::write_crt_ctrl_reg(0x05, 0x80);
    vga::write_crt_ctrl_reg(0x06, 0xBF);
    vga::write_crt_ctrl_reg(0x07, 0x1F);
    vga::write_crt_ctrl_reg(0x08, 0x00);
    vga::write_crt_ctrl_reg(0x09, 0x41);
    vga::write_crt_ctrl_reg(0x0A, 0x00);
    vga::write_crt_ctrl_reg(0x0B, 0x00);
    vga::write_crt_ctrl_reg(0x0C, 0x00);
    vga::write_crt_ctrl_reg(0x0D, 0x00);
    vga::write_crt_ctrl_reg(0x0E, 0x00);
    vga::write_crt_ctrl_reg(0x0F, 0x00);
    vga::write_crt_ctrl_reg(0x10, 0x9C);
    vga::write_crt_ctrl_reg(0x11, 0x8E);
    vga::write_crt_ctrl_reg(0x12, 0x8F);
    vga::write_crt_ctrl_reg(0x13, 0x28);
    vga::write_crt_ctrl_reg(0x14, 0x40);
    vga::write_crt_ctrl_reg(0x15, 0x96);
    vga::write_crt_ctrl_reg(0x16, 0xB9);
    vga::write_crt_ctrl_reg(0x17, 0xA3);
    vga::write_crt_ctrl_reg(0x18, 0xFF);
}
